...
fn test_skewness() {
	...
	skew_sym := stats.skewness(symmetric)
	...
	skew_right := stats.skewness(right_skewed)
...
fn test_kurtosis() {
	...
	kurt := stats.kurtosis(normal_like)
	...
	kurt_heavy := stats.kurtosis(heavy_tails)
